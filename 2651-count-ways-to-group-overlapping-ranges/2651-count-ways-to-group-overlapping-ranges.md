<h1>2651 - Count Ways to Group Overlapping Ranges</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/count-ways-to-group-overlapping-ranges/">count-ways-to-group-overlapping-ranges</a></h2><p>You are given a 2D integer array <code>ranges</code> where <code>ranges[i] = [start<sub>i</sub>, end<sub>i</sub>]</code> denotes that all integers between <code>start<sub>i</sub></code> and <code>end<sub>i</sub></code> (both <strong>inclusive</strong>) are contained in the <code>i<sup>th</sup></code> range.</p>
